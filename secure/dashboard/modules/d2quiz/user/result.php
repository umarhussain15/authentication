...
$rs1="select r.username,t.test_name,s.subject_name,r.donation,r.score,r.test_date from result r join test_info t on (r.test_id = t.test_id) join subject_info s on (s.sub_id=t.sub_id) where r.username='{$use}'";
