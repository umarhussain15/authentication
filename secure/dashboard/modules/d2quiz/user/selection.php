...
<div>
<br><br>
<p class="text-center" ><input class="btn btn-success btn-lg" style="background-color:#27ae60;"  name="submit" value="Select Subject to Give Quiz" type="submit"/> </p>

<?php
$rs="select * from subject_info";
echo "<table class='green' align=center>";
$result=mysqli_query($con,$rs);
if(!$result)
{
	die( 'Could not fetch subject from database.');
}
else 
{
	while($row=mysqli_fetch_row($result))
	{
		echo "<tr><td align=center ><a href=furtherselection.php?subid=$row[0]><font size=4>$row[1]</font></a>";
	}	
	echo "<br><br>";
	echo "</table>";
}
