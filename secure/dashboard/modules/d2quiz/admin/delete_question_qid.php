...
// getting this value from the previous page 
$que_id = $_POST['que_id'];

$query= "DELETE FROM question_info WHERE que_id = $que_id";
$query1= "DELETE FROM answer_info WHERE que_id = $que_id";
...
die ("data base query failed for $result1" . mysqli_error($con));
}

if ($result )
{
echo "Congratulations! record successfully deleted!";
?>
<br> <br> <a href= " view_question.php"> <button type="button">Click Here to View all the remaining questions</button> </a>
<br> <br> <a href= " delete_question.php"> <button type="button">Click Here to Delete more Questions</button> </a>
<?php
}
