...
<br><br>
<h3><p class="text-center">Your score for this test is </p></h3>
<?php
...
<a href="mainresponse.php"  style="black" ><input class="btn btn-success btn-lg" style="background-color:#27ae60;" value="Try another test" name="submit" type="Submit "></a>
<tr>
   <td valign="bottom"> <a href="payment" ><input class="btn btn-success btn-lg" style="background-color:#27ae60;" name="submit" value="Donate" type="submit"/> </a></td>
   </tr>
</div>
</div>
</div>
