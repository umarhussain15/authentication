...
<?php
if (isset($_SESSION['username']))			//dashboard
{
?>	
 <div align="center" class="text-center" >
<br><br><br>	
	<table border="0" align="center" style="black">
  	<tr>
  	<td  valign="bottom" > <a href="selection.php" style="black" ><input class="btn btn-success btn-lg" style="background-color:#27ae60;" value=" Select subject for Quiz" name="submit" type="Submit "></a></td> <br><br>
   </tr>
   <tr>
   <td valign="bottom"> <a href="result.php" ><input class="btn btn-success btn-lg" style="background-color:#27ae60;" name="submit" value="View Previous Result" type="submit"/> </a></td>
   </tr>
</table>
<br><br><br>
</div>
...
{
	echo "session username is missing";
}
?>
<!--php code ends here-->
