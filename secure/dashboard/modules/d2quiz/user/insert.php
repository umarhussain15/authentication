...
$query = "INSERT into question(que_id, test_id, que_des, ans1,ans2,ans3,ans4,true_ans) values ('$que_id','$test_id','$que_desc','$ans1','$ans2','$ans3','$ans4','$true_ans')";
...
<center><a href="insert_question_admin.php"><button> Add more questions </button></a></center>
...
<p>Please enter the Ques id</p>
<INPUT TYPE = "text" value "" Name="que_id">

<p>Please enter the Test id</p>
<INPUT TYPE = "text" value "" Name="test_id">

<p>Please enter the Actual Ques </p>
<INPUT TYPE = "text" value "" Name="que_desc">


<p>Please enter the Option 1</p>
<INPUT TYPE = "text" value "" Name="ans1">

<p>Please enter the Option 2</p>
<INPUT TYPE = "text" value "" Name="ans2">

<p>Please enter the Option 3</p>
<INPUT TYPE = "text" value "" Name="ans3">

<p>Please enter the Option 4</p>
<INPUT TYPE = "text" value "" Name="ans4">


<p>Please enter the  correct Option </p>
<INPUT TYPE = "text" value "" Name="true_ans">
