...
$query = "SELECT * FROM result WHERE username = '{$username}'";
$result = mysqli_query($con,$query);

if ($result)
{
echo "<br>"."GRADES"."<br>"."<br>"."<br>";
...
<p>Please enter the Username to check result	</p>
<INPUT TYPE = "text" value "" Name="username" required autofocus>
