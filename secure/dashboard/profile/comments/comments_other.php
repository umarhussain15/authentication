  ...
  <div class="container-fluid">
	...
	<form class="commentBox" action="comments/commentPost.php" method="post">
		<input type="hidden" name="page_name" value="user_<?php echo $_GET['id']; ?>">
		<input type="hidden" name="redirect_id" value="<?php echo $_GET['id']; ?>">
	...
	<?php
		...
		$sql = "SELECT * FROM comments join profile_users on comments.user_id = profile_users.user_id where page_name = 'user_".$_GET['id']."'";
