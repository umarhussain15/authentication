...
<?php
$rs="select * from test_info where sub_id=$subid";   // selecting test from the subject selected by user


$result1=mysqli_query($con,$rs);
if(!($result1))
{
...
{
	$test_id1=$row2['test_id'];	
}
	echo "<tr><td align=center ><a href=mcq.php?testid={$test_id1}&subid=$subid> Start Quiz</a>";
