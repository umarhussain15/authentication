...
<div class="container"> 
		...
		<div class="col-md-8"  id="slider">
			...
			<figure> <span class="slider-text">
				...
				<h4 style="line-height: 180%; font-style:italic"> &nbsp  Whatever you want to study, we’re sure to have the right course for you.
					Find online courses and a wide range of related learning content from across NUST's schools, initiatives, and programs. <span style="color: #003399; font-size:1.6em"><br>
					<br>
					Don't Miss Out </span> </h4>
  ...
  <div class="lead text-left">
	...
	<div class="row">
		<div class="col-md-6">
			<h2>NUST <img src="images\NUSTLOGO.jpg "width="80px"></h2>
			<p>The National University of Sciences and Technology aims to emerge as a comprehensive residential institution responsive to technological change, 
			dedicated to excellence and committed to international educational and research needs of the country. NUST will continue to champion 
			a tradition of distinguished teaching, research and service through evolving undergraduate,
			 postgraduate and doctoral level programmes of study in various disciplines in collaboration with renowned
			  universities inside the country and abroad.</p>
			<a class="btn btn-default" href="#">More Info</a> </div>
		<!-- /.col-md-4 -->
		<div class="col-md-6">
		
			<h2>Udacity <img src="images\udacity.png "width="120px"></h2>
			<p>Our mission is to bring accessible, affordable, engaging, and highly effective higher education to the world. We believe that higher
			 education is a basic human right, and we seek to empower our students to advance their education and careers.
			 Education is no longer a one-time event but a lifelong experience. Education should be less passive listening 
			 (no long lectures) and more active doing. 
			 Education should empower students to succeed not just in school but in life.</p>
			<a class="btn btn-default" href="https://www.udacity.com/">More Info</a> </div>
		<!-- /.col-md-4 --> 
