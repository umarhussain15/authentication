...
$query = "select * from question_info q join test_info t using (test_id) join subject_info s using (sub_id)  WHERE s.subject_name ='{$test_id}'";
...
while($row=mysqli_fetch_assoc($result))
	...
	echo "<td>". $row["ques_desc"]. "</td>";
	echo '</tr>';
	}
	echo '</table>';
	echo '</div>';
	echo '</div>';
// *********** NOW process for deleting the question using question ID takes places here
	?>
	
	 
	
	<FORM NAME ="delete_question_qid" METHOD ="POST" ACTION = "delete_question_qid.php">


<p>Please enter the Question ID from the above questions which you want to delete </p>

<INPUT TYPE = "text" value "" Name="que_id" required autofocus>
...
<p>Please enter the Subject Name whose question you want to delete </p>
