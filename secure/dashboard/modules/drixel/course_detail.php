...
<div class="container">
	<div class="row">
		<div class="col-sm-12 course_image_Enroll" id=""> <img src= <?php echo $course["image_logo"]; ?> class="img-responsive" alt="Responsive image"> </div>
	</div>
</div>
<div class="row top-buffer"> <a href="./enrollment_confirm.php?course_id=<?php    if(isset($_GET["course_id"])) {
 	echo $_GET["course_id"];}
	?>" class="btn btn-warning btn-lg col-sm-2 col-sm-offset-5" style="height:45px"><span class="glyphicon glyphicon-pencil"></span> Enroll in this Course</a> </div>
<div class="row">
	<div class="col-sm-10 col-sm-offset-1">
		<h2 id="showSummary"> <a><i id="chev" class="fa fa-chevron-right"></i>&ensp;Course Summary</a></h2>
		<div id="summary"  hidden="true">
			<p id="des-text"> <?php echo $course["description"]; ?> </p>
		</div>
